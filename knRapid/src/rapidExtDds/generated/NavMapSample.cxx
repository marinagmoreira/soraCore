...
DDS_TypeCode* OctetMapLayer_get_typecode()
{
    ...
    OctetMapLayer_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)rapid::OctetSequence128K_get_typecode();
        ...
        const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    if (!rapid::OctetSequence128K_initialize_w_params(&sample->data,allocParams)) {
        return RTI_FALSE;
    }
...
{    
    ...
    rapid::OctetSequence128K_finalize_w_params(&sample->data, deallocParams);
    ...
    OctetMapLayer* sample, RTIBool deletePointers)
{
    ...
    rapid::OctetSequence128K_finalize_optional_members(&sample->data, deallocParams->delete_pointers);
...
DDS_TypeCode* ShortMapLayer_get_typecode()
{
    ...
    ShortMapLayer_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)rapid::ShortSequence128K_get_typecode();
        ...
        const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    if (!rapid::ShortSequence128K_initialize_w_params(&sample->data,allocParams)) {
        return RTI_FALSE;
    }
...
{    
    ...
    rapid::ShortSequence128K_finalize_w_params(&sample->data, deallocParams);
    ...
    ShortMapLayer* sample, RTIBool deletePointers)
{
    ...
    rapid::ShortSequence128K_finalize_optional_members(&sample->data, deallocParams->delete_pointers);
