...
MarkerArraySequence*
MarkerArraySequencePluginSupport_create_data_w_params(
    const struct DDS_TypeAllocationParams_t * alloc_params){
    MarkerArraySequence *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, MarkerArraySequence);

    if(sample != NULL) {
        if (!::rapid::ext::arc::MarkerArraySequence_initialize_w_params(sample,alloc_params)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }        
...
MarkerArraySequence *
MarkerArraySequencePluginSupport_create_data_ex(RTIBool allocate_pointers){
    MarkerArraySequence *sample = NULL;
    ...
    if(sample != NULL) {
        if (!::rapid::ext::arc::MarkerArraySequence_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }        
...
MarkerArraySequence *
MarkerArraySequencePluginSupport_create_data(void)
{
    return ::rapid::ext::arc::MarkerArraySequencePluginSupport_create_data_ex(RTI_TRUE);
}


void 
MarkerArraySequencePluginSupport_destroy_data_w_params(
    MarkerArraySequence *sample,
    const struct DDS_TypeDeallocationParams_t * dealloc_params) {

    ::rapid::ext::arc::MarkerArraySequence_finalize_w_params(sample,dealloc_params);
...
void 
MarkerArraySequencePluginSupport_destroy_data_ex(
    MarkerArraySequence *sample,RTIBool deallocate_pointers) {

    ::rapid::ext::arc::MarkerArraySequence_finalize_ex(sample,deallocate_pointers);
...
void 
MarkerArraySequencePluginSupport_destroy_data(
    MarkerArraySequence *sample) {

    ::rapid::ext::arc::MarkerArraySequencePluginSupport_destroy_data_ex(sample,RTI_TRUE);

}


RTIBool 
MarkerArraySequencePluginSupport_copy_data(
    MarkerArraySequence *dst,
    const MarkerArraySequence *src)
{
    return ::rapid::ext::arc::MarkerArraySequence_copy(dst,src);
}


void 
MarkerArraySequencePluginSupport_print_data(
    const MarkerArraySequence *sample,
    const char *desc,
    unsigned int indent_level)
{
...
RTIBool 
MarkerArraySequencePlugin_copy_sample(
    PRESTypePluginEndpointData endpoint_data,
    MarkerArraySequence *dst,
    const MarkerArraySequence *src)
{
    if (endpoint_data) {} /* To avoid warnings */
    return ::rapid::ext::arc::MarkerArraySequencePluginSupport_copy_data(dst,src);
}
...
unsigned int 
MarkerArraySequencePlugin_get_serialized_sample_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
RTIBool 
MarkerArraySequencePlugin_serialize(
    PRESTypePluginEndpointData endpoint_data,
    const MarkerArraySequence *sample, 
    struct RTICdrStream *stream,    
    RTIBool serialize_encapsulation,
...
RTIBool 
MarkerArraySequencePlugin_deserialize_sample(
    PRESTypePluginEndpointData endpoint_data,
    MarkerArraySequence *sample,
    struct RTICdrStream *stream,   
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ::rapid::ext::arc::MarkerArraySequence_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
...
RTIBool MarkerArraySequencePlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
...
unsigned int 
MarkerArraySequencePlugin_get_serialized_sample_min_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
 ...
 */
unsigned int
MarkerArraySequencePlugin_get_serialized_sample_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment,
...
PRESTypePluginKeyKind 
MarkerArraySequencePlugin_get_key_kind(void)
{
...
RTIBool 
MarkerArraySequencePlugin_serialize_key(
    PRESTypePluginEndpointData endpoint_data,
    const MarkerArraySequence *sample, 
    struct RTICdrStream *stream,    
    RTIBool serialize_encapsulation,
...
RTIBool MarkerArraySequencePlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    MarkerArraySequence *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
unsigned int
MarkerArraySequencePlugin_get_serialized_key_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
...
RTIBool 
MarkerArraySequencePlugin_serialized_sample_to_key(
    PRESTypePluginEndpointData endpoint_data,
    MarkerArraySequence *sample,
    struct RTICdrStream *stream, 
    RTIBool deserialize_encapsulation,  
    ...
    unsigned int indent_level)
{
    ...
    rapid::ext::arc::MarkerArraySequencePluginSupport_print_data(
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (!rapid::ext::arc::MarkerArraySequencePlugin_serialize(
            endpoint_data,
            &sample->marker_array, 
            stream, 
            RTI_FALSE, encapsulation_id, 
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (!rapid::ext::arc::MarkerArraySequencePlugin_deserialize_sample(
            endpoint_data,
            &sample->marker_array,
            stream, 
            RTI_FALSE, RTI_TRUE, 
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (!rapid::ext::arc::MarkerArraySequencePlugin_skip(
            endpoint_data,
            stream, 
            RTI_FALSE, RTI_TRUE, 
            endpoint_plugin_qos)) {
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  rapid::ext::arc::MarkerArraySequencePlugin_get_serialized_sample_max_size(
        endpoint_data,RTI_FALSE,encapsulation_id,current_alignment);
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  rapid::ext::arc::MarkerArraySequencePlugin_get_serialized_sample_min_size(
        endpoint_data,RTI_FALSE,encapsulation_id,current_alignment);
    ...
    const RosMarkerArraySample * sample) 
{
    ...
    current_alignment += rapid::ext::arc::MarkerArraySequencePlugin_get_serialized_sample_size(
        endpoint_data,RTI_FALSE, encapsulation_id, 
