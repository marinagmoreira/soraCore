...
#ifndef RosMarkerArraySamplePlugin_1253988688_h
#define RosMarkerArraySamplePlugin_1253988688_h
...
#define MarkerArraySequencePlugin_get_sample PRESTypePluginDefaultEndpointData_getSample  
#define MarkerArraySequencePlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define MarkerArraySequencePlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 
 

#define MarkerArraySequencePlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define MarkerArraySequencePlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
    Support functions:
 * -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern MarkerArraySequence*
...
MarkerArraySequencePluginSupport_copy_data(
    MarkerArraySequence *out,
    const MarkerArraySequence *in);
...
NDDSUSERDllExport extern RTIBool
MarkerArraySequencePlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
MarkerArraySequencePlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    MarkerArraySequence * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
#endif /* RosMarkerArraySamplePlugin_1253988688_h */
