...
DDS_TypeCode* Marker_get_typecode()
{
    ...
    static DDS_TypeCode_Member Marker_g_tc_members[15]=
    {
        {
    ...
    Marker_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)rapid::String32_get_typecode();
    Marker_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
    Marker_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)rapid::ext::arc::ShapeType_get_typecode();
    Marker_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)rapid::ext::arc::Action_get_typecode();
    Marker_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)rapid::Transform3D_get_typecode();
    Marker_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)rapid::Vec3f_get_typecode();
    Marker_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)rapid::Color4f_get_typecode();
    Marker_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_longlong;
    Marker_g_tc_members[9]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_boolean;
    Marker_g_tc_members[10]._representation._typeCode = (RTICdrTypeCode *)rapid::ext::arc::PointSequence1K_get_typecode();
    Marker_g_tc_members[11]._representation._typeCode = (RTICdrTypeCode *)rapid::ext::arc::ColorSequence1K_get_typecode();
    Marker_g_tc_members[12]._representation._typeCode = (RTICdrTypeCode *)rapid::String32_get_typecode();
    Marker_g_tc_members[13]._representation._typeCode = (RTICdrTypeCode *)rapid::String32_get_typecode();
    Marker_g_tc_members[14]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_boolean;
...
/** tf frame name because RAPID header does not specify frame name */

    if (!rapid::String32_initialize_w_params(&sample->frame_id,allocParams)) {
        return RTI_FALSE;
    }
...
/** tf frame name because RAPID header does not specify frame name */
    ...
    rapid::String32_finalize_w_params(&sample->frame_id, deallocParams);
...
/** tf frame name because RAPID header does not specify frame name */
    ...
    rapid::String32_finalize_optional_members(&sample->frame_id, deallocParams->delete_pointers);
...
DDS_TypeCode* MarkerArraySequence_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode MarkerArraySequence_g_tc_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(32,NULL);

    static DDS_TypeCode MarkerArraySequence_g_tc =
    {{
        DDS_TK_ALIAS, /* Kind*/
        DDS_BOOLEAN_FALSE, /* Is a pointer? */
        -1, /* Ignored */
        (char *)"rapid::ext::arc::MarkerArraySequence", /* Name */
        NULL, /* Content type code is assigned later */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        ...
        NULL, /* Ignored */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for MarkerArraySequence */

    if (is_initialized) {
        return &MarkerArraySequence_g_tc;
    }

    MarkerArraySequence_g_tc_sequence._data._typeCode = (RTICdrTypeCode *)rapid::ext::arc::Marker_get_typecode();
    MarkerArraySequence_g_tc._data._typeCode = (RTICdrTypeCode *)&MarkerArraySequence_g_tc_sequence; /* Content type code */
...
RTIBool MarkerArraySequence_initialize(
    MarkerArraySequence* sample)
{
    return ::rapid::ext::arc::MarkerArraySequence_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}

RTIBool MarkerArraySequence_initialize_ex(
    MarkerArraySequence* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
    struct DDS_TypeAllocationParams_t allocParams =
        DDS_TYPE_ALLOCATION_PARAMS_DEFAULT;
    ...
    return ::rapid::ext::arc::MarkerArraySequence_initialize_w_params(
        sample,&allocParams);
}

RTIBool MarkerArraySequence_initialize_w_params(
        MarkerArraySequence* sample,
        const struct DDS_TypeAllocationParams_t * allocParams)
{
...
void MarkerArraySequence_finalize(
    MarkerArraySequence* sample)
{
    ::rapid::ext::arc::MarkerArraySequence_finalize_ex(sample,RTI_TRUE);
}
 
void MarkerArraySequence_finalize_ex(
    MarkerArraySequence* sample,RTIBool deletePointers)
{        
    struct DDS_TypeDeallocationParams_t deallocParams =
            DDS_TYPE_DEALLOCATION_PARAMS_DEFAULT;
    ...
    ::rapid::ext::arc::MarkerArraySequence_finalize_w_params(
        sample,&deallocParams);
}
           
void MarkerArraySequence_finalize_w_params(
    MarkerArraySequence* sample,
    const struct DDS_TypeDeallocationParams_t * deallocParams)
{
    if (sample) { } /* To avoid warnings */
...
void MarkerArraySequence_finalize_optional_members(
    MarkerArraySequence* sample, RTIBool deletePointers)
{   
    struct DDS_TypeDeallocationParams_t deallocParamsTmp =
        DDS_TYPE_DEALLOCATION_PARAMS_DEFAULT;
...
RTIBool MarkerArraySequence_copy(
    MarkerArraySequence* dst,
    const MarkerArraySequence* src)
{
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'MarkerArraySequence' sequence class.
 */
#define T            MarkerArraySequence
#define TSeq         MarkerArraySequenceSeq
#define T_initialize_w_params ::rapid::ext::arc::MarkerArraySequence_initialize_w_params
#define T_finalize_w_params   ::rapid::ext::arc::MarkerArraySequence_finalize_w_params
#define T_copy       ::rapid::ext::arc::MarkerArraySequence_copy
...
DDS_TypeCode* RosMarkerArraySample_get_typecode()
{
    ...
    RosMarkerArraySample_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)rapid::ext::arc::MarkerArraySequence_get_typecode();
        ...
        const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    if (!rapid::ext::arc::MarkerArraySequence_initialize_w_params(&sample->marker_array,allocParams)) {
        return RTI_FALSE;
    }
...
{    
    ...
    rapid::ext::arc::MarkerArraySequence_finalize_w_params(&sample->marker_array, deallocParams);
    ...
    RosMarkerArraySample* sample, RTIBool deletePointers)
{
    ...
    rapid::ext::arc::MarkerArraySequence_finalize_optional_members(&sample->marker_array, deallocParams->delete_pointers);
    ...
    const RosMarkerArraySample* src)
{
    ...
    if (!rapid::ext::arc::MarkerArraySequence_copy(
