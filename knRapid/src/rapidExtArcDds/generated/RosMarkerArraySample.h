...
#ifndef RosMarkerArraySample_1253988688_h
#define RosMarkerArraySample_1253988688_h
...
#define rapid_ext_arc_Marker_LAST_MEMBER_ID 14
...
#define rapid_ext_arc_MarkerArraySequence_LAST_MEMBER_ID rapid_ext_arc_Marker_LAST_MEMBER_ID
typedef  rapid::ext::arc::MarkerSeq  MarkerArraySequence;
...
NDDSUSERDllExport DDS_TypeCode* MarkerArraySequence_get_typecode(void); /* Type code */
    
DDS_SEQUENCE(MarkerArraySequenceSeq, MarkerArraySequence);                                        
            
NDDSUSERDllExport
RTIBool MarkerArraySequence_initialize(
        MarkerArraySequence* self);
...
void MarkerArraySequence_finalize_ex(
        MarkerArraySequence* self,RTIBool deletePointers);
...
typedef RosMarkerArraySample Type;
    ...
    rapid::ext::arc::MarkerArraySequence  marker_array;
...
#endif /* RosMarkerArraySample_1253988688_h */
